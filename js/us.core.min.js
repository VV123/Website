    ...
    $us.$window.on(
      ...
      function () {
        this.$usSectionVideoContainer.each(function () {
          ...
          if (
            window.innerWidth <
            parseInt($videoContainer.data("video-disable-width"))
          ) {
  ...
  $us.collapsibleContent.prototype = {
    init: function (container) {
      ...
      this.$container.on(
        ...
        this._events.toggleContent.bind(this)
      );
...
!(function ($, undefined) {
  ...
  function USHeader(settings) {
    ...
    this.breakpoints = { laptops: 1280, tablets: 1024, mobiles: 600 };
  ...
  $.extend(USHeader.prototype, $us.mixins.Events, {
    ...
    currentStateIs: function (state) {
      return (
        state &&
        ["default"].concat(Object.keys(this.breakpoints)).indexOf(state) !==
          -1 &&
        this.state === state
      );
    },
    ...
    _isVerticalScrollable: function () {
      ...
      if (
        (this.currentStateIs("default") || this.currentStateIs("laptops")) &&
        this.isFixed()
      ) {
      ...
      scroll: function () {
        ...
        if (
          ...
          if (documentHeight > headerHeight) {
            var canvasHeight =
                parseInt($us.canvas.winHeight) + this.canvasOffset,
            ...
            if (this.bodyHeight > headerHeight) {
              if (scrollTop < this._headerScrollRange[0]) {
                ...
                this._headerScrollRange[1] =
                  this._headerScrollRange[0] + scrollRangeDiff;
                cssProps = { position: "fixed", top: this.adminBarHeight };
              } else if (
              ...
              cssProps = { position: "absolute", top: this.adminBarHeight };
            }
            if (cssProps) {
  ...
  $us.PageScroller.prototype = {
    ...
    _destroy: function () {
      ...
      document.removeEventListener(
        "mousewheel",
        that._events.mouseWheelHandler
      );
      document.removeEventListener(
        "DOMMouseScroll",
        that._events.mouseWheelHandler
  ...
  $us.UsSharing.prototype = {
    init: function (container, options) {
      ...
      if (!this.$container.hasClass("w-sharing-tooltip")) {
        ...
        this.$copy2clipboard = this.$container.find(
    ...
    showTooltip: function (e) {
      this.$container.find(".w-sharing-item").each(
        function (index, elm) {
      ...
      this.$container.find(".w-sharing-item").each(
        function (index, elm) {
          ...
          if ($(elm).attr("data-url")) {
            $(elm).attr(
              "data-url",
              $(elm).attr("data-url").replace("{{image}}", this.sharingImage)
            );
          }
        }.bind(this)
      );
...
!(function ($, _undefined) {
  ...
  $.extend(USWooCommerce.prototype, {
    ...
    _switchCart: function () {
      this.$cart.on(
        "focus.upsolution blur.upsolution",
        function (e) {
